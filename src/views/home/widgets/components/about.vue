<template>
	<card-pro title="关于项目" prefix-icon="ele-QuestionFilled" shadow="hover">
		...
		<p>
			<a href="https://gitee.com/zuohuaijun/Shin.NET.git" target="_blank">
				<img src="https://gitee.com/zuohuaijun/Shin.NET/badge/star.svg?theme=dark" alt="star" style="vertical-align: middle" />
				<img src="https://gitee.com/zuohuaijun/Shin.NET/badge/fork.svg?theme=dark" alt="fork" style="vertical-align: middle" />
